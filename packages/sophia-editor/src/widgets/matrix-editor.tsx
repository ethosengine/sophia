import {getMatrixSize, matrixLogic} from "@ethosengine/perseus-core";
import {
    components,
    Changeable,
    EditorJsonify,
...
type Props = EditorProps<PerseusMatrixWidgetOptions>;
...
class MatrixEditor extends React.Component<Props> {
    ...
    change: ChangeFn<PerseusMatrixWidgetOptions> = createGuardedChange(this);
