...
class InteractiveGraphEditor extends React.Component<Props> {
    ...
    serialize(): PerseusInteractiveGraphWidgetOptions {
        ...
        // NOTE(Sprint-13): The graph ref was removed during modernization.
        // If graph user input is needed for serialization in the future,
        // implement proper ref handling via React.createRef().
