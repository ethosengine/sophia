...
import {components, Expression} from "@ethosengine/sophia";
...
class ExpressionEditor extends React.Component<Props, State> {
    ...
    handleTexInsert: (arg1: string) => void = (_str) => {
        // TODO(Sprint-13): This method accessed a removed ref. If TeX insertion
        // is needed, implement proper ref handling for the Expression component.
    };
