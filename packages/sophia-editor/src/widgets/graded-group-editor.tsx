...
import {gradedGroupLogic} from "@ethosengine/perseus-core";
import {
    components,
    ApiOptions,
    Changeable,
...
type Props = EditorProps<PerseusGradedGroupWidgetOptions>;
...
class GradedGroupEditor extends React.Component<Props> {
    ...
    change: ChangeFn<PerseusGradedGroupWidgetOptions> = createTypedChange(this);
