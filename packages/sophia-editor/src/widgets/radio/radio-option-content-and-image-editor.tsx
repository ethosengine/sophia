import {Util} from "@ethosengine/sophia";
...
>((props, ref) => {
    ...
    // Ref for focusing the content textarea
    const containerRef = React.useRef<HTMLDivElement>(null);

    React.useImperativeHandle(ref, () => ({
        focus: () => {
            // Find the textarea within the container and focus it
...
RadioOptionContentAndImageEditor.displayName =
