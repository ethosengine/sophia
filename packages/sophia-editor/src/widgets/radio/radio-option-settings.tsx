...
>(
    (
        ...
        // Ref to the content editor for focus delegation
        const contentEditorRef = React.useRef<FocusableHandle>(null);
...
RadioOptionSettings.displayName = "RadioOptionSettings";
