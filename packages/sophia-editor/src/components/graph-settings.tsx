...
import type {Coords, MarkingsType} from "@ethosengine/perseus-core";
...
class GraphSettings extends React.Component<Props, State> {
    ...
    // Ref for background URL input (replaces string ref)
    private bgUrlRef = React.createRef<HTMLInputElement>();
