...
// Default strings for standalone use
export {mockStrings} from "./strings";
export type {PerseusStrings} from "./strings";
...
/**
 * Typed Changeable utilities
 *
 * These provide type-safe alternatives to the legacy Changeable mixin.
 * Use createTypedChange to get a properly typed change function.
 *
 * @example
 ...
 *     change: ChangeFn<MyWidgetOptions> = createTypedChange(this);
 * }
 */
export {
    createTypedChange,
 ...
 *
 * Re-exported from sophia-core for consumer convenience.
 * Consumers can use these to implement custom scoring strategies
 * or to work with the built-in mastery/discovery strategies.
 */
export type {
    ScoringStrategy,
    WidgetScoringResult,
