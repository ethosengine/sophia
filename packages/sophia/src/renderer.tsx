    ...
    implements GetPromptJSONInterface
{
    ...
    static defaultProps: DefaultProps = {
        ...
        alwaysUpdate: false,
        reviewMode: false,
        linterContext: SophiaLinter.linterContextDefault,
    };
        ...
        if (widgetInfo) {
            ...
            return (
                <WidgetContainer
                    ...
                    linterContext={SophiaLinter.pushContextStack(
    ...
    render(): React.ReactNode {
        ...
        if (this.props.linterContext.highlightLint) {
            ...
            SophiaLinter.runLinter(parsedMarkdown, fullLinterContext, true);
